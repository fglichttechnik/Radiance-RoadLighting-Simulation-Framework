...
class configGenerator:
    ...
    def printLightsRad( self ):
            ...
            for index, poleArray in enumerate(self.Poles):
                if poleArray.isSingle == True:
                    if poleArray.PoleSide == "Left":
                        f.write( "!xform  -t -1 " + str( poleArray.PolePositionX ) + " 0 " + self.workingDirPath + self.LDCDirSuffix + "/" + poleArray.PoleLDC + '_' + str(index)  + "_light_pole.rad\n" )
                    else:
                        f.write( "!xform -rz -180 -t "+ str( self.scene.NumLanes * self.scene.LaneWidth + 1 )+" " + str( poleArray.PolePositionX ) + " 0 " + self.workingDirPath + self.LDCDirSuffix + "/" + poleArray.PoleLDC + "_light_pole.rad\n" )
                elif poleArray.PoleSide == "Left":
                    print "making left poles"
                    if firstArrayHandled == False or poleArray.IsStaggered == False:
                        f.write( "!xform  -t -1 -"+ str(poleArray.PoleSpacing) +" 0 -a 4 -t 0 "+ str(poleArray.PoleSpacing) +" 0 " + self.workingDirPath + self.LDCDirSuffix + "/" + poleArray.PoleLDC + '_' + str(index)  + "_light_pole.rad\n" )
            #f.write( "!xform -e -t -1 -"+ str(self.Poles[0].PoleSpacing) +" 0 -a 4 -t 0 "+ str(self.Poles[0].PoleSpacing) +" 0 " + self.workingDirPath + self.radDirPrefix + "/light_pole.rad\n" )
                        ...
                        f.write( "!xform  -t -1 -" + str( 0.5 * poleArray.PoleSpacing) +" 0 -a 4 -t 0 "+ str(poleArray.PoleSpacing) +" 0 " + self.workingDirPath + self.LDCDirSuffix + "/" + poleArray.PoleLDC + '_' + str(index)  + "_light_pole.rad\n" )
                else:
                    print "making right poles"
                    if firstArrayHandled == False or poleArray.IsStaggered == False:
                        f.write( "!xform  -rz -180 -t " + str( self.scene.NumLanes * self.scene.LaneWidth + 1 ) + " -"+ str(poleArray.PoleSpacing) +" 0 -a 4 -t 0 "+ str(poleArray.PoleSpacing) +" 0 " + self.workingDirPath + self.LDCDirSuffix + "/" + poleArray.PoleLDC + '_' + str(index)  + "_light_pole.rad\n" )
                        firstArrayHandled = True
                    else:
                        f.write( "!xform  -rz -180 -t " + str( self.scene.NumLanes * self.scene.LaneWidth + 1 ) + " -"+ str( 0.5 * poleArray.PoleSpacing) +" 0 -a 4 -t 0 "+ str(poleArray.PoleSpacing) +" 0 " + self.workingDirPath + self.LDCDirSuffix + "/" + poleArray.PoleLDC + '_' + str(index)  + "_light_pole.rad\n" )
